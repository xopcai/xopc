...
以下为方向概览；多音轨覆盖水位、问答权限、原生采集及可靠事件的详细契约以 [P1/P2 技术设计](./voice-meeting-p1-p2-technical-design.md) 为准，工程顺序见 [分阶段实施与验收](./voice-meeting-p1-p2-delivery-plan.md)。扩展项尚未实施。
