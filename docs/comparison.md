...
| **AI employee or role agent** | Performing a defined organizational role or queue of delegated jobs | xopc is centered on one person's changing intentions. Its goal is to reduce the person's burden, not compress their role into dispatch and approval; it earns initiative through correction and explicit authority. |
