...
export const AutomationSchema = z.object({
  ...
  notificationPolicy: z.enum(['attention', 'all', 'none']).optional(),
  completionWebhookUrl: z.string().optional(),
...
export const AutomationRunSchema = z.object({
  ...
  currentPhase: z.enum(['queued', 'action', 'completion_hook', 'cancelling', 'completed']).optional(),
