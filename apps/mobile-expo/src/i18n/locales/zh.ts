...
export const zh: MessageBundle = {
  ...
  homePage: {
    ...
    sectionAgents: '智能体',
    sectionLibrary: '资料库',
    sectionRecentOutcomes: '最近完成',
    sectionOutcomesRunning: '正在推进',
    sectionOutcomesNeedsYou: '需要你',
    outcomeStatusRunning: '正在推进',
    outcomeStatusNeedsYou: '需要你',
    outcomeStatusCompleted: '已完成',
    noOutcomesRunning: '还没有正在推进的事情',
    sectionChats: '对话',
    chatViewAll: '查看更多',
    noChats: '还没有 AI 对话',
    askAi: '问 AI',
    ...
    outcomeDefinition: '怎样才算完成',
    outcomeDeliverables: '交付物',
    outcomeReceipts: '执行回执',
    outcomeDefinitionPending: '系统正在进一步明确完成标准。',
    outcomeReceiptsEmpty: '还没有执行回执。',
    outcomeLoadFailed: '无法加载这个结果。',
    outcomeRun: '开始推进',
    outcomePause: '暂时暂停',
    outcomeResume: '继续推进',
    outcomeCancel: '结束事项',
    outcomeActionFailed: '操作失败，请重试。',
  ...
  workPage: {
    ...
    outcomeLabel: '期望结果',
    outcomePlaceholder: '你希望 xopc 完成什么？',
    projectLabel: '项目',
