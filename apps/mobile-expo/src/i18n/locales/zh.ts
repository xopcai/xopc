...
export const zh: MessageBundle = {
  ...
  chat: {
    ...
    messageReadAloudConsentTitle: '使用在线朗读',
    messageReadAloudConsentDescription: '待朗读的回答会发送给当前配置的语音服务生成音频。',
    messageReadAloudConsentCancel: '取消',
    messageReadAloudConsentConfirm: '同意并朗读',
    messageEdit: '编辑',
    messageRetry: '重试',
