...
export const en = {
  ...
  gatewayConnect: {
    flow: {
      reviewInput: "A message needs review",
      queuedInput: "Saved on this phone. Sends when connected.",
      inspect: "Review",
      retryInput: "Retry sending",
      copyInput: "Copy text",
      removeInput: "Remove from queue",
      removeInputHint: "This stops local retries. Work already received by the computer continues.",
      retryInputFailed: "Unable to send. If the conversation was reset, copy the text and send it again.",
  ...
  chat: {
    ...
    voiceReleaseCenterHint: 'Release to send · slide sideways · slide up to lock',
    ...
    voiceReleaseLockHint: 'Release to lock recording',
    voiceLocked: 'Locked — you can let go and keep recording',
    voiceReview: 'Review, delete, convert, or send',
    voiceStop: 'Stop',
    voiceDelete: 'Delete',
    voiceConvertToText: 'To text',
