...
export const en = {
  ...
  tasksPage: {
    ...
    taskLabel: 'Desired task',
    taskPlaceholder: 'What do you want xopc to get done?',
    completionCriteria: 'Completion checks',
    completionCriteriaPlaceholder: 'One check per line (optional)',
    agentLabel: 'Agent',
    automaticAgent: 'Use project or gateway default',
    projectLabel: 'Project',
    dependencies: 'Depends on',
    dependenciesDescription: 'xopc starts this task after every selected task is complete.',
    letXopcChoose: 'Let xopc choose or create a project',
    selected: 'Selected',
    preparePlan: 'Prepare work plan',
    confirmPlan: 'Confirm work plan',
