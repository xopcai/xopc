...
export const en = {
  ...
  homePage: {
    ...
    sectionRecentOutcomes: 'Recently completed',
    sectionOutcomesRunning: 'In progress',
    sectionOutcomesNeedsYou: 'Needs you',
    outcomeStatusRunning: 'In progress',
    outcomeStatusNeedsYou: 'Needs you',
    outcomeStatusCompleted: 'Completed',
    noOutcomesRunning: 'Nothing is moving yet',
    sectionChats: 'Chats',
    ...
    outcomeDefinition: 'Definition of done',
    outcomeDeliverables: 'Deliverables',
    outcomeReceipts: 'Execution receipts',
    outcomeDefinitionPending: 'xopc is still clarifying the completion criteria.',
    outcomeReceiptsEmpty: 'No execution receipts yet.',
    outcomeLoadFailed: 'Could not load this outcome.',
    outcomeRun: 'Start working',
    outcomePause: 'Pause',
    outcomeResume: 'Continue',
    outcomeCancel: 'End outcome',
    outcomeActionFailed: 'The action failed. Please try again.',
  ...
  workPage: {
    ...
    outcomePlaceholder: 'What do you want xopc to get done?',
