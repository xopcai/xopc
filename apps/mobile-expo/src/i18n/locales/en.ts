...
export const en = {
  mobileExperience: {
    ...
    "personal": "You",
    "allWork": "All work",
    "progressHint": "What needs you, what is underway, and what is ready.",
    "progressSummary": "{{needs}} need you · {{moving}} underway",
    "upcoming": "Up next",
    "workTools": "Run tools",
    "connectHint": "Connect to your workspace to get started.",
    "loadFailed": "Could not load this section",
    "retry": "Tap to retry",
    "needsYou": "Needs you",
    "nothingNeeded": "Nothing needs your attention.",
    "ongoing": "Underway",
    "nothingRunning": "No work underway.",
    "recentClosed": "Recently closed",
    "noClosed": "Closed work will appear here.",
    "libraryHint": "Notes, files, and recordings, ready to continue.",
    "searchLibrary": "Search library",
    "createContent": "Create or add",
    "quickAccess": "Browse",
    "inboxPending": "{{count}} items waiting to be organized",
    "recentItems": "Recently used",
    "noLibraryItems": "Notes, files, and recordings you use will appear here.",
    "createNote": "New note",
    "uploadFiles": "Browse and upload files",
    "startRecording": "Start meeting recording",
    "personalServices": "My services",
    "deviceStatus": "Device and status",
    "agentsHint": "Manage the agents working for you",
    "sharingHint": "View shared content and collaboration",
    "workspaceConnected": "Workspace connected",
    "workspaceDisconnected": "Workspace not connected",
    "statusOn": "On",
    "statusOff": "Off",
    "recentFiles": "Recent files",
    "recentNotes": "Recent notes",
    "noFiles": "Files you save or create will appear here.",
    "noNotes": "Capture an idea to start your library.",
    "files": "Browse files",
    "notes": "All notes",
    "inbox": "Inbox",
    "untitled": "Untitled",
    ...
    "queueHint": "Sent after the current response",
    "edit": "Edit",
    "cancel": "Cancel",
    "save": "Save",
  ...
  voice: {
    ...
    assistantCallHint: 'Talk and carry out tasks',
    ...
    "languageZh": "Chinese",
    "languageEn": "English",
    "draftChanged": "Your draft changed. Insert the transcript after your current text?",
    "languages": "Recognition languages",
    "bargeIn": "Interrupt by speaking",
    "supported": "Supported",
    "notSupported": "Unavailable",
    "previewHint": "Preview uses the configured task-call voice. Voice preview for chat-only calls is not available yet.",

    "approval": "Confirm action",
    "approve": "Approve",
    "deny": "Deny",
    "approvalError": "Could not load or submit the confirmation. Check the task before continuing.",
    "manage": "Manage voice service",
    ...
    "backgroundHint": "Applies to your next call, including when the screen is locked.",
    ...
    "ending": "Ending call…",
    "resume": "Continue call",
    "service": "Voice service",
    "ready": "Configured",
    "unavailable": "Unavailable",
    "serviceHint": "Providers and voices are managed on your paired gateway.",
    "error": "Voice is unavailable. Check your connection and voice service.",
    "network": "Connection interrupted. Check the transcript before repeating your last sentence.",
    "permission": "Allow microphone access in system settings.",
    "busy": "The microphone or call audio is in use. End the other audio activity and try again.",
    "recordingBusy": "Finish the current recording before starting a voice call.",
    "sessionBusy": "This Chat is still replying or already has a voice call. Finish it and try again.",
    "upgrade": "Update your gateway and rebuild the mobile app to use voice calls.",
    "sessionChanged": "This conversation has changed. End this call and start again from Chat.",
    "timeLimit": "The call time limit was reached. You can continue in this Chat.",
    "inputDropped": "That audio could not be sent. Please repeat your last sentence.",
    "interruption": "Audio was interrupted. Tap Continue when ready.",
    "audioFocusLost": "Other audio activity interrupted the call. Tap Continue when it ends.",
    "captureFailed": "Microphone capture stopped. Tap Continue to retry.",
    "routeLost": "The active audio device disconnected. Check your headset or speaker, then continue.",
    "backgroundPaused": "The app went into the background, so the call paused. Enable background calls in voice settings to continue there.",
    "recording": "Listening…",
    "processing": "Preparing your text…",
    "noSpeech": "No speech recognized.",
    "finishCallToSend": "End the call to send this draft.",
    "returnChat": "View conversation",
    "voiceInputHint": "Speech becomes an editable draft. Nothing is sent automatically."
},
  // ── Navigation / screens ────────────────────────────────
  privacy: {
    ...
    consentRequired: "Data sharing is not authorized. Tap below to review and continue.",
  ...
  drawer: {
    ...
    aboutYou: 'About you',
    you: 'You',
    profileHint: 'Your shared profile',
    searchSessions: 'Search chats',
    filterByProject: 'Filter by project',
    allProjects: 'All projects',
    noProject: 'No project',
    noSessions: 'No chats yet',
    noSessionsFound: 'No matching chats',
  ...
  chat: {
    contextCenter: {
      ...
      noWork: 'No project or task is attached.',
      noEnvironment: 'No workspace environment is available.',
      noSources: 'No source notes are attached.',
      environmentUnavailable: 'This environment is currently unavailable.',
      loadFailed: 'Could not load context.',
      chooseProject: 'Choose a project',
      noProject: 'No project',
      chooseEnvironment: 'Run new chat in',
      startNewChat: 'Start new chat',
      changeScope: 'Change work scope',
      projectsFailed: 'Could not load projects.',
      environmentCheckFailed: 'Could not check this project environment.',
      ...
      hostRoot: 'Gateway host',
      directoriesFailed: 'Could not load folders from the gateway host.',
      environmentReason: {
        workspace_unavailable: 'The project directory is unavailable.',
        git_commit_required: 'Worktree requires a Git repository with at least one commit.',
        uncommitted_changes: 'Commit changes first, or use Local.',
      },
    },
    ...
    references: {
      open: 'Open reference: {{title}}',
      searchFile: 'Search file names or paths',
      limit: 'Reference limit reached. Remove an item from your draft to choose another.',
      title: "Reference material",
      hint: "Choose an item to add to your draft",
      note: "Notes",
      task: "Tasks",
      file: "Files",
      addNote: "Reference note",
      addTask: "Reference task",
      addFile: "Add file",
      search: "Search by name or content",
      clear: "Clear search",
      close: "Close",
      localFile: "Choose from this device",
      workspace: "Current conversation workspace",
      recent: "Recently updated · up to 50 items",
      results: "Search results · up to 50 items",
      error: "Could not load. Please try again.",
      retry: "Retry",
      noResults: "No matches. Try another keyword.",
      empty: "No items available yet",
      untitled: "Untitled",
      remove: "Remove reference",
    },
    contextLimitReached: 'You can reference up to 5 notes or tasks per turn',
    contextSearchEmpty: 'No files, folders, or notes found',
    ...
    moreArtifacts: 'View {{count}} more',
    attachmentsHeading: 'Attachments',
    moreAttachments: 'View {{count}} more attachments',
    moreReferences: 'View {{count}} more references',
    ...
    voiceSendFailed: 'Voice message failed to send. Your recording is kept for retry.',
    ...
    clarifySend: 'Send',
    clarifyUseSuggested: 'Use suggestion',
    clarifyAgentDecide: 'Let assistant decide',
    clarifyCancel: 'Cancel task',
    clarifyDurableNote: 'Available across restarts and devices until you answer or cancel.',
    clarifyApprovalTimeout: 'For safety, this approval expires.',
    clarifyTimeRemaining: 'Time left: {{time}}',
    messageCopy: 'Copy',
  ...
  settings: {
    ...
    gatewayName: 'Name',
    gatewayNameSaved: 'Gateway name saved',
  ...
  librarySearch: {
    ...
    gatewayDisconnectedHint: 'Connect a gateway to search your library.',
    idleTitle: 'Search your library',
    idleHint: 'Find notes and files without mixing in chats or work.',
    searching: 'Searching…',
    noResultsTitle: 'No results',
    noResultsHint: 'Try another keyword.',
    placeholder: 'Search notes and files…',
    clearSearch: 'Clear search',
    searchFailed: 'Library search failed.',
    retry: 'Retry',
    kind: {
      file: 'File',
      note: 'Note',
  ...
  filesPage: {
    ...
    emptyHint: 'Files you create or upload appear here.',
  ...
  sharingPage: {
    ...
    empty: 'No shares yet',
    emptyHint: 'Files and content you share appear here.',
