...
import type { MobileEndpointToolExecutionContext } from './host';

export interface MobileEndpointToolExecutionResult {
...
function textResult(text: string): MobileEndpointToolExecutionResult {
...
export async function executeMobileEndpointTool(
  toolName: string,
  args: Record<string, unknown>,
  context: MobileEndpointToolExecutionContext,
): Promise<MobileEndpointToolExecutionResult> {
  if (toolName === 'mobile.file.pick') {
  ...
  if (toolName === 'mobile.notification.show') {
