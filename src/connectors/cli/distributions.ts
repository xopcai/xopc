...
export const WPS365_DISTRIBUTIONS: Record<string, CliDistribution> = {
  'darwin-arm64': { url: 'https://github.com/wps365-open/cli/releases/download/v0.3.6/wps365-cli-aarch64-apple-darwin.tar.gz', integrity: 'sha256-2605dab1a208327e3fc3b739d589c878ad17c7a22a133dd26171e76c6f81c08f', archiveEntry: 'wps365-cli' },
  'linux-arm64': { url: 'https://github.com/wps365-open/cli/releases/download/v0.3.6/wps365-cli-aarch64-unknown-linux-gnu.tar.gz', integrity: 'sha256-f9de5dc0a0e5a682bd53c9df8e21196a6090b308db2c339b516f6389ecea0ab3', archiveEntry: 'wps365-cli' },
  'darwin-x64': { url: 'https://github.com/wps365-open/cli/releases/download/v0.3.6/wps365-cli-x86_64-apple-darwin.tar.gz', integrity: 'sha256-d7c63d3e59446bf0a27361282a7751a818791752bcb8c9b478cb937ff8216f33', archiveEntry: 'wps365-cli' },
  'linux-x64': { url: 'https://github.com/wps365-open/cli/releases/download/v0.3.6/wps365-cli-x86_64-unknown-linux-gnu.tar.gz', integrity: 'sha256-68b955a8488edcb82ed5373752a937d9ec3588abfb550223dda3d6f0c1a27588', archiveEntry: 'wps365-cli' },
};
