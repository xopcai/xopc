...
function createSchemaV1(db: DatabaseSync): void {
  ...
  ensureTranscriptFts(db);
}

function createSchemaV2Extensions(db: DatabaseSync): void {
  db.exec(`
...
function ensureTranscriptFts(db: DatabaseSync): void {
  db.exec(`
...
function ensureNotesFts(db: DatabaseSync): void {
  db.exec(`
...
function ensureMemoryFts(db: DatabaseSync): void {
  db.exec(`
