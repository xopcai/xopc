...
const RECOMMENDED_MODEL_PATTERNS: Record<string, RegExp[]> = {
  ...
  moonshotai: [/^kimi-k2\.7-code$/i, /^kimi-k2\.6$/i, /^kimi-k2\.5$/i],
  'moonshotai-cn': [/^kimi-k2\.7-code$/i, /^kimi-k2\.6$/i, /^kimi-k2\.5$/i],
  'kimi-coding': [/^kimi-k2\.7-code$/i, /^kimi-for-coding$/i],
