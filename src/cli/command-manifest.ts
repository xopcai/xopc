...
export const ROOT_HELP_COMMANDS: RootHelpCommand[] = [
  ...
  { name: 'resume [options] [conversationId]', description: 'Resume a previous TUI session' },
  ...
  { name: 'support', description: 'Create a redacted diagnostic report for an xopc problem' },
  { name: 'runtime', description: 'Manage Node.js and Python tool runtimes used by agents' },
  { name: 'mcp', description: 'Expose selected Gateway capabilities over MCP' },
  { name: 'platform', description: 'Connect to XOPC Cloud or an enterprise platform' },
