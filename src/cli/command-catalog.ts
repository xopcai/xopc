...
export const cliCommandCatalog: readonly CliCommandCatalogEntry[] = [
  ...
  { commandPath: ['goal'], policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'list'], exact: true, policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'new'], exact: true, policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'show'], exact: true, policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'pause'], exact: true, policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'resume'], exact: true, policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'archive'], exact: true, policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'runs'], exact: true, policy: { loadExtensions: 'never' } },
  { commandPath: ['goal', 'checklist'], policy: { loadExtensions: 'never' } },
