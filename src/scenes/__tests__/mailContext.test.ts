...
describe('scene mail context', () => {
  ...
  beforeEach(() => {
    ...
    db.exec(`CREATE TABLE connector_accounts(id TEXT, principal_id TEXT);
      CREATE TABLE connector_connections(id TEXT, account_id TEXT, principal_id TEXT, status TEXT);
      ...
      INSERT INTO connector_accounts VALUES ('personal', 'local-owner'), ('work', 'local-owner');
      INSERT INTO connector_connections VALUES ('connection', 'personal', 'local-owner', 'active'), ('work-connection', 'work', 'local-owner', 'active');
