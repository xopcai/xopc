...
const BUILTIN_SPECS: BuiltinWorkflowSpec[] = [
  ...
  { name: 'weekly_review', description: 'Review the week and produce a short, prioritized action plan for next week.', whenToUse: 'Use for a weekly retrospective and planning session.', tags: ['productivity', 'brainstorm'], perspectives: perspectives('Tasks and progress', 'Friction and unfinished work', 'Priorities and capacity') },
];
