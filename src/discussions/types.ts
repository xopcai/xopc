export { DISCUSSION_STATUSES } from '@xopcai/gateway-contract';
export type {
  DiscussionStatus,
  DiscussionSource,
  DiscussionProjectInferenceSource,
  DiscussionFailureStage,
  DiscussionFact,
  DiscussionChapter,
  DiscussionTemplate,
  ...
  DiscussionCapture,
  DiscussionTranscriptSegmentStatus,
  DiscussionTranscriptSegment,
  DiscussionTranscriptStats,
