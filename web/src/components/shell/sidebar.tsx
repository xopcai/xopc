    ...
    <div className="app-sidebar-content flex min-h-0 flex-1 flex-col">
      ...
      >
        <SidebarTaskList
          ...
          scrollHeader={
            <>
              <div className="app-sidebar-sticky-surface sticky top-0 z-20 px-4 pt-1.5 pb-0.5">
                <Link
                  to="/chat/new"
                  state={{ forceNewChat: true }}
                  className={cn(
                    'flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-medium leading-6 transition-colors duration-200 ease-out md:py-1.5',
                  ...
                  onClick={() => onNavigate?.()}
                >
                  <Plus className="size-4 shrink-0 opacity-90" strokeWidth={1.75} aria-hidden />
              ...
              <nav className="px-4" aria-label="Main">
                <div className="flex flex-col gap-0.5">
                  <SidebarNavItems onNavigate={onNavigate} visibleLimit={visibleAppCount} />
                </div>
              </nav>
              ...
              <div
                ...
                tabIndex={0}
                className="group flex h-3 touch-none cursor-row-resize items-center px-4 focus-visible:outline-none"
