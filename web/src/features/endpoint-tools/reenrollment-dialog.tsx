  ...
  return (
    <Dialog.Root open={open} onOpenChange={(next) => !next && settleEndpointReenrollment(false)}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="xopc-dialog-content fixed left-1/2 top-1/2 z-[150] flex h-[min(22rem,calc(100vh-2rem))] w-[min(30rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-xl border border-edge bg-surface-overlay shadow-float focus:outline-none">
