...
function buildFieldSeeds(language: StoredLanguage): FieldSeed[] {
  ...
  return [
    ...
    // --- Agent defaults: Chat ---
    {
      ...
      path: '/settings/agent-defaults?tab=chat',
    ...
    },
    {
      ...
      path: '/settings/agent-browser?focus=extension',
    ...
    },
    {
      ...
      path: '/settings/agent-browser?focus=local',
    ...
    },
    {
      ...
      path: '/settings/agent-browser?focus=cloak',
    ...
    // --- MCP ---
    {
      ...
      path: '/settings/agent-defaults?tab=mcp',
      keywords: ['mcp', 'server', 'tools', 'external', 'stdio', '服务器'],
    },
