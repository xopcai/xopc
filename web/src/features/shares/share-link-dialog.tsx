  ...
  return (
    ...
    >
      <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3">
        <div className="rounded-lg border border-edge bg-surface-inset px-3 py-2.5">
        ...
        <label className="mt-3 flex flex-col gap-1.5">
          ...
          <input
            ...
            className="h-10 rounded-lg border border-edge bg-surface-inset px-3 text-sm text-fg outline-none placeholder:text-fg-subtle focus:border-edge-strong disabled:opacity-60"
          />
        </label>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={cn(
            ...
            'overflow-hidden rounded-lg border border-edge bg-surface-overlay shadow-popover outline-none',
          )}
        >
