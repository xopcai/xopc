        ...
        <SettingsFormSection>
          ...
          <div className="flex flex-col gap-5">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <Field label={a.label.browserAllowPrivateUrls} description={a.desc.browserAllowPrivateUrls}>
                <label className="flex cursor-pointer items-center gap-2 text-sm text-fg">
                  <input
                    type="checkbox"
                    className="size-3.5 shrink-0 rounded border-edge"
              ...
              <Field label={a.label.browserCommandTimeout} description={a.desc.browserCommandTimeout}>
                <input
                  type="number"
                  className={inputClassName()}
                  min={5}
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <Field label={a.label.browserCloudProvider} description={a.desc.browserCloudProvider}>
                <select
              ...
              <Field label={a.label.browserDialogPolicy} description={a.desc.browserDialogPolicy}>
                <select
                  className={selectClassName()}
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <Field label={a.label.browserCdpUrl} description={a.desc.browserCdpUrl}>
                <input
                  type="text"
                  className={inputClassName()}
              ...
              <Field label={a.label.browserDialogTimeout} description={a.desc.browserDialogTimeout}>
                <input
                  type="number"
                  className={inputClassName()}
                  min={1}
