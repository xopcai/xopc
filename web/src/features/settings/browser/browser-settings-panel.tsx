...
} from './panels/backend-mode-list';
import { BrowserBehaviorSections } from './panels/browser-behavior-sections';
import { BrowserDocsLink } from './panels/browser-docs-link';
import { browserFocusElementId } from './panels/browser-focus';
import { BrowserSetupGuide } from './panels/browser-setup-guide';
import {
  doctorStatus,
  extensionDoctorStatus,
  extensionStatusLabelFor,
  statusLabelFor,
} from './panels/browser-status';
import type { BrowserTabId } from './panels/browser-tabs';
import { isBrowserBackendTab } from './panels/browser-tabs';
import { CdpCard } from './panels/cdp-card';
import { CloakCard } from './panels/cloak-card';
import { CloudCard } from './panels/cloud-card';
import { ExtensionCard } from './panels/extension-card';
import { LocalCard } from './panels/local-card';
import { useBrowserDoctor } from './panels/use-browser-doctor';
import { useBrowserInstallStream } from './panels/use-browser-install-stream';
