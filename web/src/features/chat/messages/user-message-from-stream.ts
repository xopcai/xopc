...
/** Parse `user_message` / `user_transcript` run payloads into a UI user row. */
export function userMessageFromStreamPayload(parsed: Record<string, unknown>): Message | null {
  const timestamp =
