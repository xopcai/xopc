...
ARG XOPC_BUILD_GITHUB_APP_CLIENT_ID
ARG XOPC_BUILD_GITHUB_APP_SLUG

ENV CI=true \
    NODE_ENV=development \
    PNPM_HOME=/pnpm \
    PATH=/pnpm:$PATH \
    XOPC_BUILD_GITHUB_APP_CLIENT_ID=${XOPC_BUILD_GITHUB_APP_CLIENT_ID} \
    XOPC_BUILD_GITHUB_APP_SLUG=${XOPC_BUILD_GITHUB_APP_SLUG}
